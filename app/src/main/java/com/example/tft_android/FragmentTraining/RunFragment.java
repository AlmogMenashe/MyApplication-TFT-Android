...
public class RunFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        BHalf = view.findViewById(R.id.button30);
        BHour = view.findViewById(R.id.button60);
        BHalfHour = view.findViewById(R.id.button90);
        BTwoHour = view.findViewById(R.id.button120);
